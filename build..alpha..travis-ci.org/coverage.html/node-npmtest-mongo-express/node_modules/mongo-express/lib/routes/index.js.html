...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mongo-express/node_modules/mongo-express/lib/routes/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mongo-express/node_modules/mongo-express/lib/routes/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">82.98% <small>(39 / 47)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">82.98% <small>(39 / 47)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mongo-express/node_modules/mongo-express/lib/routes/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
  // Homepage route
  exp.index = <span class="fstat-no" title="function not covered" >function (req, res) {</span>
<span class="cstat-no" title="statement not covered" >    const ctx = {</span>
      title: 'Mongo Express',
      info: false,
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (typeof req.adminDb === 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >      return res.render('index');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    req.adminDb.serverStatus((err, info) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      if (err) {</span>
        // TODO: handle error
<span class="cstat-no" title="statement not covered" >        console.error(err);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      ctx.info = info;</span>
<span class="cstat-no" title="statement not covered" >      res.render('index', ctx);</span>
    });
  };
&nbsp;
  return exp;
